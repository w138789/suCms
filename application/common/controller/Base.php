...
class Base extends \think\Controller {
    ...
    public function _initialize() {
        ...
        //获取request信息
        $this->requestInfo();
        if($this->auto) $this->model = model(CONTROLLER_NAME);
    }
    ...
    protected function requestInfo() {
        ...
        $this->url = $this->request->module() . '/' . parse_name($this->request->controller(),0) . '/' . $this->request->action();
