...
class Action extends Admin {
    ...
    public function add() {
        ...
        if (IS_POST) {
            ...
            if (false != $result) {
                action_log('add_action', 'Action', $result, session('admin_auth.admin_id'));
    ...
    public function edit($id = null) {
        ...
        if (IS_POST) {
            ...
            if ($result !== false) {
                action_log('edit_action', 'Action', $id, session('admin_auth.admin_id'));
    ...
    public function del() {
        ...
        if ($result) {
            action_log('delete_action', 'Action', $id, session('admin_auth.admin_id'));
    ...
    public function setstatus() {
        ...
        if ($result !== false) {
            action_log('setstatus_action', 'Action', $id, session('admin_auth.admin_id'));
    ...
    public function dellog() {
        ...
        if ($res !== false) {
            action_log('delete_actionlog', 'ActionLog', $id, session('admin_auth.admin_id'));
            return $this->success('删除成功！');
        } else {
            return $this->error('删除失败！');
        }
    ...
    public function clear($id = '') {
        ...
        if ($res !== false) {
            //记录行为
            action_log('clear_actionlog', 'ActionLog', $id, session('admin_auth.admin_id'));
